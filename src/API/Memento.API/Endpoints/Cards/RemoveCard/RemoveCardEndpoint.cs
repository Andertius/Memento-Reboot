...
public sealed class RemoveCardEndpoint(ICardService cardService, IImageService imageService) : Endpoint<RemoveCardRequest>
{
    ...
    {
        await _imageService.DeleteCardImageAsync(request.Id, token);
